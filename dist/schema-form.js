...
(function(root, factory) {
  if (typeof define == 'function' && define.amd)
    define(['angular', 'angular-schema-form/module', 'ObjectPath'], factory);
  else
    factory(angular);
}(this, function(angular) {
...
(function(root, factory) {
  if (typeof define == 'function' && define.amd)
    define(['angular', 'angular-schema-form/module', 'angular-schema-form/sfPath'], factory);
  else
    factory(angular);
}(this, function(angular) {
  /**
...
(function(root, factory) {
  if (typeof define == 'function' && define.amd)
    define(['angular', 'angular-schema-form/module', 'angular-schema-form/sfPath'])
}(this, function(angular) {
  /**
   * Schema form service.
